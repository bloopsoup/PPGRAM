...
class Main {
    ...
    static update() {
        ...
        const [pickedStatus, pickedName, pickedDate, pickedImage] = [document.getElementById('picked-status'), document.getElementById('picked-name'), document.getElementById('picked-date'), document.getElementById('picked-image')];
